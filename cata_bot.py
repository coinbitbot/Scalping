...
from creds_v import POLONIEX_API_KEY, POLONIEX_SECRET_KEY, GMAIL_USER, GMAIL_PASSWORD, TARGET
...
PAIRS = ['BTC_ETH', 'BTC_XRP', 'BTC_XEM', 'BTC_LTC', 'BTC_STR', 'BTC_BCN', 'BTC_DGB', 'BTC_ETC', 'BTC_SC', 'BTC_DOGE',
         ...
         'BTC_EXP', 'BTC_VTC', 'BTC_GRC', 'BTC_NAV', 'BTC_FLDC', 'BTC_POT', 'BTC_RADS', 'BTC_NAUT', 'BTC_BTCD',
         'BTC_XPM', 'BTC_NOTE', 'BTC_NXC', 'BTC_PINK', 'BTC_OMNI', 'BTC_VIA', 'BTC_XBC', 'BTC_NEOS', 'BTC_PASC',
         'BTC_BTM', 'BTC_SBD', 'BTC_VRC', 'BTC_BLK', 'BTC_BCY', 'BTC_XVC', 'BTC_HUC', 'BTC_BELA', 'BTC_BCH', 'BTC_ZRX']
...
def main():
    ...
    logging.basicConfig(level=logging.INFO,
                        ...
                        datefmt='%H:%M:%S',
                        filename='{}cata_log/logger{}.log'.format(PROJECT_PATH,
    ...
    if pairs_bought != '':
        ...
        for pair in PAIRS:
            ...
            if not is_green(candles_data[1]):
                ...
                print('colour '+ str(candles_data[1]['open']) + " > " + str(candles_data[1]['close']))
                print("colour condition")
            else:
                first_condition = False
            if candles_data[1]['volume'] > MIN_VOLUME:
                second_condition = True
                print('volume ' + str(candles_data[1]['volume']))
                print("min condition")
            else:
                second_condition = False
            print(candles_data[1]['volume'])
